...
namespace VosmerkaUser08
{
    ...
    public partial class VosmerkaEntities : DbContext
    {
        private static VosmerkaEntities _context;
        public VosmerkaEntities()
            : base("name=VosmerkaEntities")
        {
        }

        public static VosmerkaEntities GetContext()
        {
            if (_context == null)
                _context = new VosmerkaEntities();
            return _context;
        }
